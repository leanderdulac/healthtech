...
| [SHARED_PATIENT_REGISTRY_MUTATIONS_P1.md](./SHARED_PATIENT_REGISTRY_MUTATIONS_P1.md) + [shared-patient-registry-mutations-p1.yaml](./shared-patient-registry-mutations-p1.yaml) | **DRAFT** (`0.2.0-draft`) — cadastro compartilhado (mutação / dedup / consent / anexo). Revisão 2026-09-24 alinha markdown↔OpenAPI (compat P0, território, idempotência, merge, links/consents). **Não** CONFIRMED. |
